...
│
├── Moment Spec 表.md            # 14 幕配置表（判定規則/初始化修正）⭐
├── Options Data 格式.md         # 對話輪次/選項資料結構 ⭐
├── moment-configs/               # 14 個時刻的完整 JSON 配置 ⭐
...
**故事核心**：5年前（2019年），你認識了辦公室同事。他們一開始對你很好，但從2019年7月開始，他們一步步霸凌你，讓你走向深淵。現在你要回到過去，找出真正的兇手，復仇，改變這一切。
