...
├── roo-code/                    # Roo Code 專用入口（只讀這裡避免走偏）⭐
...
8. **復活機制.md** - 了解復活機制設計（含失手看廣告重玩該關＝再試一次）
...
17. **roo-code/auto-dev-plan.md** - Roo Code 自動化開發計畫入口（含 SSOT/任務清單/缺口備註）
